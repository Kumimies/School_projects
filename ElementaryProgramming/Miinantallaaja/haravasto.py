...
def aseta_piirto_kasittelija(kasittelija):
    """
    Asettaa funktion, joka piirtikkunan grafiikat. Jokseenkin tärkeä.
    Käsittelijä on funktioää peli-, jolla ei ole parametreja, ja sen tulisi piirtää
...
def piirra_tekstia(teksti, x, y, vari=(0, 0, 0, 255), fontti="serif", koko=30):
    """
